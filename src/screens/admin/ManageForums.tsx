...
export const ManageForums: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col relative pb-24 md:pb-8">
      {/* Header */}
      <div className="bg-white border-b border-gray-100 p-4 pt-8 sticky top-0 z-10 flex justify-between items-center md:rounded-t-[2.5rem] md:mt-6 md:hidden">

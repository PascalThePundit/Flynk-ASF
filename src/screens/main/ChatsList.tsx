...
export const ChatsList: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] flex flex-col pb-24 md:pb-0">
      <div className="bg-white px-6 py-6 pb-4 sticky top-0 z-20 border-b border-gray-100 flex flex-col gap-4 md:rounded-t-[2.5rem] md:mt-6">
        <h1 className="text-3xl font-extrabold text-[#0A1628] font-display tracking-tight md:hidden">Chats</h1>
